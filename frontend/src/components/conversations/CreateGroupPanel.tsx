...
export function CreateGroupPanel({ onClose, onCreate }: CreateGroupPanelProps) {
  ...
  const filteredFriends = participantQuery.trim()
    ? friends.filter((f) => {
  ...
  return (
    <div className="flex h-full flex-col bg-talkapp-sidebar">
      <header className="flex shrink-0 items-center justify-between border-b border-talkapp-border/50 px-5 py-3 safe-t safe-l safe-r">
        <h1 className="font-bold text-xl tracking-tight text-talkapp-primary ml-5">Crear grupo</h1>
        <button
          type="button"
          onClick={onClose}
      ...
      <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0 p-4">
        <div className="chat-messages-scroll flex-1 min-h-0 overflow-y-auto flex flex-col gap-4 pr-1">
          ...
          <div>
            ...
            <div className="flex shrink-0 items-center gap-2 rounded-xl border border-talkapp-border bg-talkapp-panel pl-3 pr-3 mb-2 focus-within:border-talkapp-primary focus-within:ring-1 focus-within:ring-talkapp-primary/50">
            ...
            <div className="chat-messages-scroll max-h-52 overflow-y-auto rounded-lg border border-talkapp-border bg-talkapp-panel divide-y divide-talkapp-border">
              {friends.length === 0 ? (
                ...
                <p className="p-3 text-talkapp-fg-muted text-sm">Ningún contacto coincide con la búsqueda.</p>
              ) : (
        ...
        <div className="shrink-0 pt-4 flex flex-col gap-4 border-t border-talkapp-border mt-4">
