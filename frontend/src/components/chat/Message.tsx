      ...
      <div className="relative min-w-0 max-w-[85%] sm:max-w-[75%] overflow-visible">
        ...
        >
          ...
          <div className="flex items-center justify-end gap-1 mt-1 flex-wrap">
            ...
            {isOwn && (
              <span className="text-[10px]" title={showReadBy ? 'Visto' : 'Enviado'} aria-label={showReadBy ? 'Visto' : 'Enviado'}>
                {showReadBy ? <DoubleCheckIcon /> : <SingleCheckIcon />}
              </span>
            )}
          </div>
        </div>
...
function SingleCheckIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5 inline text-bitchat-blue-dark/70" aria-hidden>
...
function DoubleCheckIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 inline text-bitchat-blue-dark/90" aria-hidden>
